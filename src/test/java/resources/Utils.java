...
public class Utils {
	...
	public RequestSpecification requestSpecification() throws IOException {
		...
		if (req == null) {
			...
			//PrintStream log = new PrintStream(new FileOutputStream("logging_"+todaysDate+".txt", true));
			PrintStream log = new PrintStream(new FileOutputStream("logging_"+todaysDate+".txt"));
